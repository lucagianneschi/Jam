...
<div class="bg-double">	
	...
	<div id="profile" style="width:100%; max-width:500px; float:right">
		...
		<div class="large-12 columns">
		    <div id='box-userinfo'>
			<?php require_once($baseUrl . "views/recordPage/box/box-classinfo.php"); ?>
		    </div>
		    <div id='box-information'>
			<?php require_once($baseUrl . "views/recordPage/box/box-information.php"); ?>
		    </div>
			...
			function loadBoxRecord() {
			    ...
			    $.ajax({
				type: "POST",
				url: "views/recordPage/box/box-record.php",
				data: json_data,
	...
	<div id="social" style="width:100%; max-width:500px; float:left">
		...
		<div class="large-12 columns">
		    <div id='box-status'>
			<?php require_once($baseUrl . "views/recordPage/box/box-status.php"); ?>
		    </div>
			...
			function loadBoxRecordReview(limit, skip) {
			    ...
			    $.ajax({
				type: "POST",
				url: "views/recordPage/box/box-recordReview.php",
				data: json_data,
				beforeSend: function(xhr) {
				    //spinner.show();
			...
			function loadBoxComment(limit, skip) {
			    var json_data = {};
			    json_data.id = '<?php echo $id; ?>';
			    json_data.fromUserObjectId = '<?php echo $record['fromuser']['id']; ?>';
			    json_data.limit = limit;
			    json_data.skip = skip;
			    $.ajax({
				type: "POST",
				url: "views/recordPage/box/box-comment.php",
				data: json_data,
				beforeSend: function(xhr) {
				    //spinner.show();
			...
			function loadBoxOpinion(id, toUser, classBox, box, limit, skip) {
				...
				$.ajax({
				    type: "POST",
				    url: "views/recordPage/box/box-opinion.php",
				    data: json_data,
				    beforeSend: function(xhr) {
					//spinner.show();
