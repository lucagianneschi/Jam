                        ...
                        <div class="header">
                            ...
                            <div id="player">	
                                <div class="icon-header" id='header-box-thum'>
                                    <img src="<?php echo Yii::app()->params['defaultImages']['DEFRECORDTHUMB']; ?>"  onerror="this.src='<?php echo Yii::app()->params['defaultImages']['DEFRECORDTHUMB']; ?>'" alt="<?php echo $userUsername; ?>">
                                </div>				
                                <!--PLAYER-->
