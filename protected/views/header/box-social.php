...
/*
 * @todo qui manca il codice delle recupero delle notifiche
...
//@todo creare codice per le notifiche
switch ($typeNotification) {
	...
	//$detailNotification->init(10, 0);
	$numNot = $message;
	$other = Yii::t('string', 'view.header.social.message_msg');
	break;
    case 'event':
	//$detailNotification = new EventListBox();
	//$detailNotification->init(10, 0);
	//$numNot = $invited;
	$other = Yii::t('string', 'view.header.social.message_event');
	break;
    case 'relation':
	//$detailNotification = new RelationListBox();
	//$detailNotification->init($userType, 10, 0);
	$numNot = $relation;
	$other = Yii::t('string', 'view.header.social.message_relation');
	break;
    default:
	break;
}
...
<div class="row">
	...
	<div class="row">
		...
		<h3 class="inline"><?php echo Yii::t('string', 'view.header.social.title'); ?></h3>
	    </div>	
