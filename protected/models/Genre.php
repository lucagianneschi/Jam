...
class Genre extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'eventGenres' => array(self::HAS_MANY, 'EventGenre', 'id_genre'),
			'recordGenres' => array(self::HAS_MANY, 'RecordGenre', 'id_genre'),
			'songGenres' => array(self::HAS_MANY, 'SongGenre', 'id_genre'),
			'userGenres' => array(self::HAS_MANY, 'UserGenre', 'id_genre'),
		);
	}
