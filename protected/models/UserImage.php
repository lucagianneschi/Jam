...
class UserImage extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_user, id_image', 'required', 'message'=>'{attribute} field is missing'),
			array('id_user, id_image', 'length', 'max'=>11, 'message'=>'Invalid {attribute} format'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_user, id_image', 'safe', 'on'=>'search'),
		);
	}
