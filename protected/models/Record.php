...
class Record extends CActiveRecord {
	...
	return parent::model($className);
     ...
     /**
     * Decrement counters of Record instance, return false in case of error
     * @param integer $id id of the record to increment the counter
    ...
    /**
     * Increment counters of Record instance, return false in case of error
     * @param integer $id id of the record to increment the counter
     * @param string counter to be incremented
     */
