...
class EventType extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_event, id_type', 'required', 'message'=>'{attribute} field is missing'),
			array('id_event, id_type', 'length', 'max'=>11, 'message'=>'Invalid {attribute} format'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_event, id_type', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'idType' => array(self::BELONGS_TO, 'Eventtypes', 'id_type'),
