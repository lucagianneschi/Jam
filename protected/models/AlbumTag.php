 ...
 *
 * The followings are the available columns in table 'album_tag':
...
class AlbumTag extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_album, id_user', 'required', 'message'=>'{attribute} field is missing'),
			array('id_album, id_user', 'length', 'message'=>'Invalid {attribute} format'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_album, id_user', 'safe', 'on'=>'search'),
		);
	}
